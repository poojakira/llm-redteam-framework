...
This repository is maintained as a **LLM security evaluation and prompt-screening service**.

## Production purpose

run deterministic adversarial evaluations and expose authenticated scanning with explicit enforcement policy.

## Release gate

A release is promotable only when tests, API auth/security, OOD regression, dependency audit, and container build pass.
