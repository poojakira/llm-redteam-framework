...
**Earliest reachable commit on `main`:** 2026-07-11  
**Commit:** [`b89c8785307b`](https://github.com/poojakira/llm-redteam-framework/commit/b89c8785307bd1e18f91f638be86c751c538a422)  
...
- Benchmark seeds and references to older standards/datasets are not treated as project dates.
...
|---|---|---|
| Reachable Git history | Earliest reachable commit on `main` | **2026-07-11** — [`b89c8785307b`](https://github.com/poojakira/llm-redteam-framework/commit/b89c8785307bd1e18f91f638be86c751c538a422) — `Initial commit` |
